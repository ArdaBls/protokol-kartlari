...
const seed = [
  ...
  m({ folder: 'inbox', unread: false, starred: false, label: null,       from: 'Vercel',       fromEmail: 'updates@vercel.com', subject: 'Deployment succeeded',          preview: 'protokol-admin.vercel.app deployed in 28s', body: 'Production deployment for protokol-admin succeeded.\n\nDuration: 28s\nCommit: e08f69c — Release 2.2.0 — fresh for 2026\n\nView deployment →', time: 'Tue' }),
  m({ folder: 'inbox', unread: false, starred: false, label: 'work',     from: 'Aigars S.',    fromEmail: 'aigars@example.com', subject: 'Draft for landing copy',        preview: 'Take a look when you get a chance — happy to iterate.', body: 'First pass at the landing copy:\n\n> The free Bootstrap admin template, redesigned for 2026.\n> Fresh design system. Real ECharts. Real DataTables. Vite 8, vanilla JS, zero jQuery.\n\nHappy to iterate. — A.', time: 'Mon' }),
  ...
  // ── Drafts
  m({ folder: 'drafts', unread: false, starred: false, label: null,     from: 'Me', to: 'aigars@example.com', subject: 'Re: Draft for landing copy',  preview: 'Two suggestions on the subhead — instead of …', body: "Two suggestions on the subhead:\n\n1. Lead with the year-anchor (\"redesigned for 2026\") earlier — it's the strongest signal.\n2. \"Real charts. Real tables.\" reads stronger as one beat.", time: 'Today' }),
